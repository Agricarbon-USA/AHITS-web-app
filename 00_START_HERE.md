...
| 6 | the newest `AHITS_LAUNCH_HANDOFF_*` / `AHITS_SESSION_HANDOFF_*` file (now `AHITS_SESSION_HANDOFF_2026-07-28_CC16S.md`; prior same-day: `_CC31.md`, `_CC32.md`, `_CC30.md`, `_CC29-BUILD.md`) | 2 | What last shipped + exact resume points. During launch week the LAUNCH_HANDOFF is canonical. |
