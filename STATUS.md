...
_Last updated: **2026-07-15 (session 6)**. If this date is more than a session old, trust the code and `git log` over this file, and update it._
...
1. **CC-23** (design tokens + quick fixes + first 3 primitives) → **CC-24** (subtraction + glossary) → **CC-25** (live-camera QR) — the remaining reflection-increment packets, per `AHITS_LANDING_ORDER_AND_SMOKE_CHECKLIST.md`. (**CC-22 shipped** — PR #182, `d3d1537`.)
...
- **Decisions:** `DECISIONS.md` · **Latest handoff:** `AHITS_SESSION_HANDOFF_2026-07-15.md` · **Rules for changing code:** `CLAUDE.md`
