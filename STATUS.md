...
_Last updated: **2026-07-17 (session 8)**. If this date is more than a session old, trust the code and `git log` over this file, and update it._
...
1. **CC-25** (live-camera QR) — the last reflection-increment packet, per `AHITS_LANDING_ORDER_AND_SMOKE_CHECKLIST.md`. (**CC-23**, PR #183 · **CC-24 addendum**, PR #184 · **CC-24 subtraction+glossary**, PR #185 — all shipped.)
