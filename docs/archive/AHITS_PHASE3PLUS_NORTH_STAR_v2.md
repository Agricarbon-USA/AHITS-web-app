> **⚠️ SUPERSEDED — archived for history.** This is **v2**. Its reframe — AHITS owns the field **operation** (instruments, people, operational evidence), never the sample — is **correct and carried forward**; what changed is structure: v2's bet-catalogue was reorganized around the operator's day + the manager's week under a friction budget. Superseded by **`AHITS_PHASE3PLUS_NORTH_STAR_v3.md`**. Read v3; this is kept for lineage and its fuller bet detail.
