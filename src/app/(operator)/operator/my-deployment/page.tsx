...
// UXP-3 (3d, D21): the Start-Deployment builder — with its option types, PendingItemEntry,
// PickupPreset and availFor — now lives in components/operator/NewDeploymentDialog.tsx.
